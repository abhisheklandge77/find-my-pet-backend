...
router.use('/lostPetMail', async (req, res) => {
    try {
        // Get user input
        const { petId, personName, personEmail, personAddress, personPhone, personMessage, ownerName, ownerEmail, petName, latitude, longitude } = req.body;
...
router.use('/placedOrderMail', async (req, res) => {
    try {
        ...
        const payload = {
            orderDetails, name, paymentMethod
        }
